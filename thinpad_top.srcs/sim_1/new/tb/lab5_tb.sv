...
module lab5_tb;
  ...
  initial begin
    ...
    uart.pc_send_byte(8'h65);
    uart.pc_send_byte(8'h66);
    uart.pc_send_byte(8'h67);
    uart.pc_send_byte(8'h68);
    uart.pc_send_byte(8'h69);
    uart.pc_send_byte(8'h6a);
    uart.pc_send_byte(8'h6b);
    uart.pc_send_byte(8'h6c);
    #1000 $finish;
  end
