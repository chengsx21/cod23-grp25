module if_inst_mux #(
    ...
    output reg clear_tlb_o
);

    wire [DATA_WIDTH-1:0] origin_inst;

    assign origin_inst = cache_en_i ? cache_inst_i : mem_inst_i;
    assign inst_o = (origin_inst == 32'b0000_0000_0000_0000_0001_0000_0000_1111 || origin_inst == 32'b00010010_00000000_00000000_01110011) ? 32'b0000_0000_0100_0000_0000_0000_0110_1111 : origin_inst;
    assign clear_cache_o = origin_inst == 32'b0000_0000_0000_0000_0001_0000_0000_1111 ? 1'b1 : 1'b0;
    assign clear_tlb_o = origin_inst == 32'b00010010_00000000_00000000_01110011 ? 1'b1 : 1'b0;
